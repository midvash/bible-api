...
export const DOCS_STRINGS: Record<Locale, DocsStrings> = {
  en: {
    ...
    errors: {
      ...
      shapeNote: "4xx responses are cached from 60 seconds up to 24 hours, depending on how deterministic the error is; 5xx are never cached, so retries always reach the origin.",
      colCode: "Code",
      colStatus: "HTTP",
      ...
      when: {
        ...
        VERSION_NOT_FOUND: "No version matches the given slug — the error suggests the closest one (didYouMean).",
        BOOK_NOT_FOUND: "No book matches the given slug, in any language — the error suggests the closest one (didYouMean).",
    ...
    books: {
      title: "The 66 books",
      subtitle: "Slugs work in any language, with or without hyphens (2-samuel or 2samuel). Click a book to fetch its metadata.",
  ...
  "pt-br": {
    ...
    errors: {
      ...
      shapeNote: "Respostas 4xx são cacheadas de 60 segundos a 24 horas, conforme o quão determinístico é o erro; 5xx nunca são cacheadas, então o retry sempre chega na origem.",
      colCode: "Código",
      colStatus: "HTTP",
      ...
      when: {
        ...
        VERSION_NOT_FOUND: "Nenhuma versão corresponde ao slug informado — o erro sugere o mais próximo (didYouMean).",
        BOOK_NOT_FOUND: "Nenhum livro corresponde ao slug, em qualquer idioma — o erro sugere o mais próximo (didYouMean).",
    ...
    books: {
      title: "Os 66 livros",
      subtitle: "Os slugs funcionam em qualquer idioma, com ou sem hífen (2-samuel ou 2samuel). Clique num livro para ver seus metadados.",
  ...
  es: {
    ...
    errors: {
      ...
      shapeNote: "Las respuestas 4xx se cachean de 60 segundos a 24 horas, según lo determinista que sea el error; las 5xx nunca se cachean, así el reintento siempre llega al origen.",
      colCode: "Código",
      colStatus: "HTTP",
      ...
      when: {
        ...
        VERSION_NOT_FOUND: "Ninguna versión coincide con el slug dado — el error sugiere el más cercano (didYouMean).",
        BOOK_NOT_FOUND: "Ningún libro coincide con el slug, en ningún idioma — el error sugiere el más cercano (didYouMean).",
    ...
    books: {
      title: "Los 66 libros",
      subtitle: "Los slugs funcionan en cualquier idioma, con o sin guion (2-samuel o 2samuel). Haz clic en un libro para ver sus metadatos.",
  ...
  fr: {
    ...
    errors: {
      ...
      shapeNote: "Les réponses 4xx sont mises en cache de 60 secondes à 24 heures selon le caractère déterministe de l erreur ; les 5xx ne le sont jamais, donc les retries atteignent toujours l origine.",
      colCode: "Code",
      colStatus: "HTTP",
      ...
      when: {
        ...
        VERSION_NOT_FOUND: "Aucune version ne correspond au slug donné — l erreur suggère la plus proche (didYouMean).",
        BOOK_NOT_FOUND: "Aucun livre ne correspond au slug, dans aucune langue — l erreur suggère le plus proche (didYouMean).",
    ...
    books: {
      title: "Les 66 livres",
      subtitle: "Les slugs fonctionnent dans toutes les langues, avec ou sans trait d union (2-samuel ou 2samuel). Cliquez sur un livre pour ses métadonnées.",
  ...
  de: {
    ...
    errors: {
      ...
      shapeNote: "4xx-Antworten werden je nach Determinismus des Fehlers 60 Sekunden bis 24 Stunden gecacht; 5xx nie, damit Retries immer den Origin erreichen.",
      colCode: "Code",
      colStatus: "HTTP",
      ...
      when: {
        ...
        VERSION_NOT_FOUND: "Keine Übersetzung passt zum angegebenen Slug — der Fehler schlägt die nächstliegende vor (didYouMean).",
        BOOK_NOT_FOUND: "Kein Buch passt zum Slug, in keiner Sprache — der Fehler schlägt das nächstliegende vor (didYouMean).",
    ...
    books: {
      title: "Die 66 Bücher",
      subtitle: "Slugs funktionieren in jeder Sprache, mit oder ohne Bindestrich (2-samuel oder 2samuel). Klicke ein Buch für seine Metadaten.",
  ...
  it: {
    ...
    errors: {
      ...
      shapeNote: "Le risposte 4xx sono in cache da 60 secondi a 24 ore, a seconda di quanto l errore è deterministico; le 5xx non lo sono mai, così i retry raggiungono sempre l origine.",
      colCode: "Codice",
      colStatus: "HTTP",
      ...
      when: {
        ...
        VERSION_NOT_FOUND: "Nessuna versione corrisponde allo slug indicato — l errore suggerisce la più vicina (didYouMean).",
        BOOK_NOT_FOUND: "Nessun libro corrisponde allo slug, in nessuna lingua — l errore suggerisce il più vicino (didYouMean).",
    ...
    books: {
      title: "I 66 libri",
      subtitle: "Gli slug funzionano in qualsiasi lingua, con o senza trattino (2-samuel o 2samuel). Clicca un libro per i suoi metadati.",
  ...
  zh: {
    ...
    errors: {
      ...
      shapeNote: "4xx 响应根据错误的确定性缓存 60 秒到 24 小时；5xx 从不缓存，因此重试总能到达源站。",
      colCode: "代码",
      colStatus: "HTTP",
      colWhen: "何时发生",
      when: {
        ...
        VERSION_NOT_FOUND: "没有版本匹配给定的 slug —— 错误会给出最接近的建议（didYouMean）。",
        BOOK_NOT_FOUND: "没有书卷匹配该 slug（任意语言）—— 错误会给出最接近的建议（didYouMean）。",
    ...
    books: {
      title: "全部 66 卷书",
      subtitle: "slug 支持任意语言，连字符可有可无（2-samuel 或 2samuel）。点击书卷查看其元数据。",
      oldTestament: "旧约",
      newTestament: "新约",
      chaptersAbbr: "章",
    },
  ...
  ru: {
    ...
    errors: {
      ...
      shapeNote: "Ответы 4xx кэшируются от 60 секунд до 24 часов в зависимости от детерминированности ошибки; 5xx не кэшируются никогда, чтобы повторы всегда доходили до источника.",
      colCode: "Код",
      colStatus: "HTTP",
      ...
      when: {
        ...
        VERSION_NOT_FOUND: "Ни один перевод не соответствует указанному slug — ошибка подсказывает ближайший (didYouMean).",
        BOOK_NOT_FOUND: "Ни одна книга не соответствует slug, ни на одном языке — ошибка подсказывает ближайшую (didYouMean).",
    ...
    books: {
      title: "66 книг",
      subtitle: "Slug работают на любом языке, с дефисом или без (2-samuel или 2samuel). Нажмите книгу, чтобы получить метаданные.",
  ...
  ko: {
    ...
    errors: {
      ...
      shapeNote: "4xx 응답은 오류의 결정성에 따라 60초에서 24시간까지 캐시되고, 5xx는 절대 캐시되지 않아 재시도가 항상 오리진에 도달합니다.",
      colCode: "코드",
      colStatus: "HTTP",
      colWhen: "발생 상황",
      when: {
        ...
        VERSION_NOT_FOUND: "주어진 slug와 일치하는 번역본이 없습니다 — 오류가 가장 가까운 slug를 제안합니다(didYouMean).",
        BOOK_NOT_FOUND: "어떤 언어로도 slug와 일치하는 책이 없습니다 — 오류가 가장 가까운 slug를 제안합니다(didYouMean).",
    ...
    books: {
      title: "66권 전체",
      subtitle: "slug는 모든 언어에서 동작하며 하이픈이 있어도 없어도 됩니다(2-samuel 또는 2samuel). 책을 클릭하면 메타데이터를 가져옵니다.",
      oldTestament: "구약",
      newTestament: "신약",
      chaptersAbbr: "장",
    },
